# -*- encoding: utf-8 -*-
# stub: inversion 1.4.0.pre.20200929152318 ruby lib

Gem::Specification.new do |s|
  s.name = "inversion".freeze
  s.version = "1.4.0.pre.20200929152318"
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<trollop>.freeze, ["~> 2.9"])
    s.add_development_dependency(%q<rack-test>.freeze, ["~> 1.1"])
    s.add_development_dependency(%q<rake-deveiate>.freeze, ["~> 0.14"])
    ...
    s.add_dependency(%q<trollop>.freeze, ["~> 2.9"])
    s.add_dependency(%q<rack-test>.freeze, ["~> 1.1"])
    s.add_dependency(%q<rake-deveiate>.freeze, ["~> 0.14"])
